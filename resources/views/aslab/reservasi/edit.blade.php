    ...
    <div class="col-lg-7">
        ...
        <div class="card table-card">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('aslab.reservasi.update', $reservasi->id) }}">
                    @csrf @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('aslab.reservasi.show', $reservasi->id) }}" class="btn btn-outline-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
