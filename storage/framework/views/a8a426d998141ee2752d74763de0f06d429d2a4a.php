...
<div class="card table-card mb-4">
    <div class="card-body p-4">
        <form method="GET" action="<?php echo e(route('admin.rekap.index')); ?>" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <select name="id_matkul" class="form-select">
                    ...
                    <?php $__currentLoopData = $matkuls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matkul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($matkul->id); ?>" <?php echo e(request('id_matkul') === $matkul->id ? 'selected' : ''); ?>><?php echo e($matkul->nama_matkul); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-3 d-flex gap-2">
                <button type="submit" class="btn btn-primary w-100"><i class="bi bi-search me-1"></i>Terapkan</button>
                <a href="<?php echo e(route('admin.rekap.index')); ?>" class="btn btn-outline-secondary w-100"><i class="bi bi-x-lg"></i></a>
            </div>
        </form>
    </div>
</div>
...
<div class="d-flex justify-content-end gap-2 mb-4">
    <a href="<?php echo e(route('admin.rekap.exportPdf', request()->query())); ?>" class="btn btn-outline-danger btn-sm">
        <i class="bi bi-file-earmark-pdf me-1"></i> Export PDF
    </a>
    <a href="<?php echo e(route('admin.rekap.exportExcel', request()->query())); ?>" class="btn btn-success btn-sm">
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card stat-card">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($data['jumlah_praktikum']); ?></h3>
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card stat-card">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($data['jumlah_penggunaan_lab']); ?></h3>
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card stat-card">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($data['jumlah_reservasi']); ?></h3>
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card stat-card">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($data['jumlah_pembatalan']); ?></h3>
                    <small class="text-secondary">Jumlah Pembatalan</small>
                </div>
            </div>
        </div>
        <?php if($data['ada_filter_lab_atau_matkul']): ?>
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card stat-card">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($data['jam_penggunaan_lab']); ?> <small class="fs-6 fw-normal">jam</small></h3>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RuangLab\RuangLab\resources\views/admin/rekap/index.blade.php ENDPATH**/ ?>