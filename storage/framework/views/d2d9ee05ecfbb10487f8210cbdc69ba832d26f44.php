            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="<?php echo e(route('admin.user.store')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_telp" value="<?php echo e(old('no_telp')); ?>" class="form-control" placeholder="Opsional">
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RuangLab\resources\views/admin/user/create.blade.php ENDPATH**/ ?>