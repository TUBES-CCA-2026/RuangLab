            ...
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('aslab.reservasi.store')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_pakai" value="<?php echo e(old('tanggal_pakai', $tanggalTerpilih)); ?>"
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="time" name="jam_mulai" value="<?php echo e(old('jam_mulai', $jamMulaiTerpilih)); ?>" class="form-control" required>
                        </div>
                        <div class="col-6 mb-3">
