            ...
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <ul class="list-unstyled small text-secondary mb-0">
                        ...
                        <?php if($d->mataKuliah): ?>
                        <li><i class="bi bi-journal-bookmark me-1"></i><?php echo e($d->mataKuliah->nama_matkul); ?></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="mt-4 d-flex gap-2">
                   ...
                   <?php if(in_array($reservasi->status, ['pending', 'disetujui', 'selesai'])): ?>
                    <a href="<?php echo e(route('aslab.reservasi.edit', $reservasi->id)); ?>" class="btn btn-outline-primary btn-sm">
                        <i class="bi bi-pencil me-1"></i> Edit
                    </a>
                    <?php endif; ?>
                    <?php if(in_array($reservasi->status, ['pending', 'disetujui'])): ?>
...
<?php echo $__env->make('layouts.aslab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RuangLab\resources\views/aslab/reservasi/show.blade.php ENDPATH**/ ?>