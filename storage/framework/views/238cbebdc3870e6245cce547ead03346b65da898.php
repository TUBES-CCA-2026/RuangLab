            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_telp" value="<?php echo e(old('no_telp', $user->no_telp)); ?>" class="form-control" placeholder="Opsional" inputmode="numeric" pattern="[0-9]*" maxlength="13" oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                    </div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RuangLab\RuangLab\resources\views/profile/edit.blade.php ENDPATH**/ ?>