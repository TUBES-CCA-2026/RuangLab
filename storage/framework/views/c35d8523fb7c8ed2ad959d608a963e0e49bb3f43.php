            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <form action="<?php echo e(route('admin.laboratorium.destroy', $lab->id)); ?>" method="POST" class="d-inline" data-confirm="Yakin ingin menghapus laboratorium ini?">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RuangLab\resources\views/admin/laboratorium/index.blade.php ENDPATH**/ ?>