...
<body>
    ...
    <p class="subtitle">Dicetak pada <?php echo e(now()->translatedFormat('d F Y H:i')); ?></p>

    <table class="info">
        <tr>
            <td class="label">Tahun Ajaran</td>
            <td><?php echo e($filter['tahun_ajaran']); ?></td>
        </tr>
        <tr>
            <td class="label">Laboratorium</td>
            <td><?php echo e($filter['laboratorium']); ?></td>
        </tr>
        <tr>
            <td class="label">Mata Kuliah</td>
            <td><?php echo e($filter['mata_kuliah']); ?></td>
        </tr>
    </table>
    ...
    <table class="metrik">
        ...
        <tbody>
            <tr>
                ...
                <td class="angka"><?php echo e($data['jumlah_praktikum']); ?></td>
            </tr>
            <tr>
                <td>Jumlah Penggunaan Laboratorium</td>
                <td class="angka"><?php echo e($data['jumlah_penggunaan_lab']); ?></td>
            </tr>
            <tr>
                <td>Jumlah Reservasi</td>
                <td class="angka"><?php echo e($data['jumlah_reservasi']); ?></td>
            </tr>
            <tr>
                <td>Jumlah Pembatalan</td>
                <td class="angka"><?php echo e($data['jumlah_pembatalan']); ?></td>
            </tr>
            <tr>
                <td>Jam Penggunaan Laboratorium</td>
                <td class="angka"><?php echo e($data['jam_penggunaan_lab']); ?> jam</td>
            </tr>
        </tbody>
    </table>
...
<?php /**PATH C:\xampp\htdocs\RuangLab\resources\views/admin/rekap/pdf.blade.php ENDPATH**/ ?>