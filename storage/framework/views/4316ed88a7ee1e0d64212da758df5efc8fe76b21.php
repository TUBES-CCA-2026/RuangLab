    ...
    <div class="col-lg-7">
        ...
        <div class="card table-card">
            <div class="card-body p-4">
                <h6 class="fw-bold mb-4">Edit Reservasi</h6>

                <?php $detail = $reservasi->detail->first(); ?>

                <form method="POST" action="<?php echo e(route('aslab.reservasi.update', $reservasi->id)); ?>">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="time" name="jam_mulai" value="<?php echo e(old('jam_mulai', \Illuminate\Support\Str::substr($detail?->jam_mulai, 0, 5))); ?>" class="form-control" required>
                        </div>
                        <div class="col-6 mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('aslab.reservasi.show', $reservasi->id)); ?>" class="btn btn-outline-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.aslab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RuangLab\resources\views/aslab/reservasi/edit.blade.php ENDPATH**/ ?>