            ...
            <div class="card-body p-4">
                ...
                <div class="mb-3 p-3 bg-light rounded-3">
                    ...
                    <p class="small text-secondary mb-0">
                        ...
                        <?php if($d->mataKuliah): ?>
                            &nbsp;|&nbsp;<i class="bi bi-journal-bookmark"></i> <?php echo e($d->mataKuliah->nama_matkul); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RuangLab\RuangLab\resources\views/admin/reservasi/show.blade.php ENDPATH**/ ?>