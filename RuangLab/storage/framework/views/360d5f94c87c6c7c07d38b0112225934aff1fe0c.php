                        ...
                        <form method="POST" action="<?php echo e(route('reservasi.store')); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="time" name="jam_selesai" value="<?php echo e(old('jam_selesai')); ?>" class="form-control" required>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RuangLab-desain-web\RuangLab\resources\views/reservasi/create.blade.php ENDPATH**/ ?>