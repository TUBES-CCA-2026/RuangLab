...
<div class="row g-3">
    ...
    <div class="col-12">
        <label class="form-label small fw-semibold">Foto Laboratorium</label>
        ...
        <small class="text-secondary">Format JPG/PNG, maks 2MB. Kosongkan jika tidak ingin mengubah foto.</small>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\RuangLab-desain-web\RuangLab\resources\views/admin/laboratorium/_form.blade.php ENDPATH**/ ?>